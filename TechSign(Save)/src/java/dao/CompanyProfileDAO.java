...
public class CompanyProfileDAO {
    ...
    public CompanyProfile getById(int id) throws SQLException, ClassNotFoundException {
    ...
    public List<CompanyProfile> getAll() throws SQLException, ClassNotFoundException {
    ...
    public List<CompanyProfile> getAllCompanies() throws SQLException, ClassNotFoundException {
        List<CompanyProfile> list = new ArrayList<>();
        String sql = "SELECT cp.id, cp.company_name, COUNT(jp.id) AS job_count " +
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                cp.setJobCount(rs.getInt("job_count"));
                list.add(cp);
            }
