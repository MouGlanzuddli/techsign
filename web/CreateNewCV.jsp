        ...
        <div id="main-wrapper">
            ...
            <div class="container py-5">
                <div class="row">
                    <!-- FORM BÊN TRÁI -->
                    <div class="col-md-6">
                        <h3 class="mb-4">Create New CV</h3>
                        <form action="CreateNewCVServlet" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" >
                        ...
                        <div class="cv-card">
                            ...
                            <div class="cv-left">
                                <div class="text-center mb-3">
                                    ...
                                    <h2 id="preview-fullname" class="fw-bold mb-1">Full Namen</h2>
                                    <h5 id="preview-jobtitle" class="text-uppercase mb-4">Profile Title</h5>
                                </div>
