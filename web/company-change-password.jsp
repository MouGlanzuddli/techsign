					...
					<div class="dashboard-nav">
						...
						<div class="dashboard-inner">
							<ul data-submenu-title="Main Navigation">
								<li><a href="UpdateCompanyProfile"><i class="fa-solid fa-gauge-high me-2"></i>Dashboard</a></li>
								<li><a href="UpdateCompanyProfile"><i class="fa-regular fa-user me-2"></i>My Profile </a></li>
								...
								<li><a href="LogoutServlet"><i class="fa-solid fa-power-off"></i> Log Out</a></li>
							</ul>
						</div>					
					</div>
				</div>
...
<!-- Modal xác nhận xóa tài khoản (đồng bộ UI với profile) -->
