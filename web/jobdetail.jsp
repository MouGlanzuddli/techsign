                                ...
                                <c:otherwise>
                                    <ul class="nav-menu">
                                        ...
                                        <li><a href="JavaScript:Void(0);">Profile CV<span class="submenu-indicator"></span></a>
                                            <ul class="nav-dropdown nav-submenu">
                                                <li><a href="CreateNewCVServlet">Create CV</a></li>
                                ...
                                <div class="jbs-roots-y1 flex-column justify-content-start align-items-start">
                                    ...
                                    <div class="jbs-roots-y6 py-3">
                                        <c:choose>
                                            ...
                                            <c:when test="${sessionScope.user == null}">
                                                <c:choose>
                                                    <c:when test="${job.status eq 'Closed' or job.status eq 'inactive'}">
                        ...
                        <div class="single-explot d-flex align-items-center">
                            ...
                            <div class="single-explot-last ps-2">
                                ...
                                <p class="text-light fw-bold fs-6 m-0">
                                    <fmt:formatNumber value="${job.salaryMin}" type="number" maxFractionDigits="0" /><a>VND</a> -
                                    <fmt:formatNumber value="${job.salaryMax}" type="number" maxFractionDigits="0" /><a>VND</a>
                                </p>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div id="uploadSection">
                                                <div class="upload-btn-wrapper full-width mb-2">
                                                    <button id="uploadBtn" type="button" class="btn full-width"
                                                        ...
                                                        <span id="uploadBtnLabel">Upload Resume</span>
                                                    </button>                                                   
                                                    <input type="file" name="resumeFile" id="resumeFile" accept="application/pdf" style="display:none;"
                                                           onchange="displayFileName()">
                                                </div>
                                                <div class="upload-btn-wrapper full-width mb-2">
                                                    <button id="cancelBtn" type="button" class="btn full-width btn-md btn-light-danger px-3 me-2"
                                                            style="display: none;" onclick="cancelFileUpload()">
                                                        Cancel CV
                                                    </button>
                                                </div>
