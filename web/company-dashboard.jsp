					...
					<div class="dashboard-nav">
						...
						<div class="dashboard-inner">
							<ul data-submenu-title="Main Navigation">
								...
								<li class="active"><a href="company-dashboard.jsp"><i class="fa-regular fa-user me-2"></i>My Profile </a></li>
								<li><a href="MyJobsServlet"><i class="fa-solid fa-business-time me-2"></i>My Jobs</a></li>
