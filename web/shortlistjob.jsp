...
<html lang="en">
    ...
    <!-- Mirrored from shreethemes.net/jobstock-landing-2.2/jobstock/candidate-saved-jobs.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2024 11:59:38 GMT -->
    <head>
        <meta charset="utf-8">
                    ...
                    <div class="dashboard-nav">
                        ...
                        <div class="dashboard-inner">
                            <ul data-submenu-title="Main Navigation">
                                <li><a href="dashboardcandidate.jsp"><i class="fa-solid fa-gauge-high me-2"></i>User Dashboard</a></li>
                                <li><a href="candidate-profile.html"><i class="fa-regular fa-user me-2"></i>My Profile </a></li>
                                <li><a href="resumeCandidate.jsp"><i class="fa-solid fa-file-pdf me-2"></i>My Resumes</a></li>
                                <li><a href="AppliedJobsServlet"><i class="fa-regular fa-paper-plane me-2"></i>Applied jobs</a></li>
                                ...
                                <li class="active"><a href="ShortlistJobServlet"><i class="fa-solid fa-bookmark me-2"></i>List Saved Jobs</a></li>
                                <li><a href="FavouriteCompanyServlet"><i class="fa-solid fa-user-clock me-2"></i>Favourite Companies</a></li>
                    ...
                    <div class="dashboard-tlbar d-block mb-4">
                        <div class="row">
                            <div class="colxl-12 col-lg-12 col-md-12">
                                <h1 class="mb-1 fs-3 fw-medium">Shortlisted jobs</h1>
                    ...
                    <div class="dashboard-widg-bar d-block">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">                                       
                                    <div class="card-body">
                                        <form method="post" action="ShortlistJobServlet">
                                        ...
                                        <div class="row justify-content-start gx-3 gy-4">
                                            ...
                                            <c:forEach var="job" items="${savedJobs}">
                                                <div class="col-xl-12 col-lg-12 col-md-12 mb-3">
                                                    <div class="jbs-list-box border rounded p-3">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-6 d-flex align-items-center">
                                                                <div class="me-3">
                                                                    <a href="JobDetail?id=${job.id}">
                                                                        <img src="assets/img/l-1.png" class="img-fluid rounded" alt="Company Logo" style="width: 60px; height: 60px;">
                                                                    </a>
                                                                </div>
                                                                <div>
                                                                    <div>
                                                                        <span class="badge bg-light-success text-success mb-1">${job.jobType}</span>
                                                                    </div>
                                                                    <h5 class="mb-1">
                                                                        <a href="JobDetail?id=${job.id}" class="text-dark fw-bold">${job.title}</a>
                                                                    </h5>
                                                                    <div class="text-muted small">
                                                                        ${job.companyName} &bull;
                                                                        <i class="fa-solid fa-location-dot me-1"></i> ${job.location} &bull;
                                                                        <fmt:formatDate value="${job.postedAt}" pattern="dd MMM yyyy" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-2 text-center">
                                                                <c:choose>
                                                                    <c:when test="${job.status eq 'Active'}">
                                                                        <span class="text-sm-muted text-light bg-success py-2 px-3 rounded">Active</span>
                                                                    </c:when>
                                                                    <c:when test="${job.status eq 'Expired'}">
                                                                        <span class="text-sm-muted text-light bg-danger py-2 px-3 rounded">Expired</span>
                                                                    </c:when>
                                                            ...
                                                            <div class="col-md-4 text-end">
                                                                <a href="DeleteBookmarkServlet?jobId=${job.jobPostingsId}" class="btn btn-md btn-light-danger px-3 me-2"><i class="fa-solid fa-xmark"></i></a>
                                                                <a href="JobDetail?id=${job.jobPostingsId}&saved=true" class="btn btn-light-primary px-3">View Detail</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="pagination justify-content-center">
                                            <c:forEach begin="1" end="${totalPages}" var="i">
                                                <li class="page-item ${i == currentPage ? 'active' : ''}">
                                                    <a class="page-link" href="ShortlistJobServlet?page=${i}">${i}</a>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    </nav>
