...
<div class="company-jobs" id="content-section">
    ...
    <!-- Filter Controls -->
    <div class="filter-controls modern-filter">
        <div class="filter-group">
            <label for="statusFilter"><i class="fas fa-filter"></i> Trạng thái:</label>
            <select id="statusFilter" onchange="filterPosts()" class="modern-select">
        ...
        <div class="filter-group">
            ...
            <div class="search-input-wrapper">
                <input type="text" id="searchInput" placeholder="Tìm theo tiêu đề..." onkeyup="filterPosts()" class="modern-input">
                <i class="fas fa-search search-icon"></i>
            </div>
        </div>
        
        <div class="filter-group">
            <button onclick="refreshPosts()" class="btn btn-primary modern-btn">
    ...
    <!-- Posts Grid -->
    <div class="posts-grid modern-posts-grid" id="postsGrid">
        <!-- Posts will be loaded here via JavaScript -->
    </div>
</div>

<!-- Post Details Modal -->
<div id="postDetailsModal" class="modal modern-modal">
    <div class="modal-content modern-modal-content">
        <div class="modal-header modern-modal-header">
            <h3><i class="fas fa-info-circle"></i> Chi tiết bài đăng</h3>
