...
<section id="alerts" class="section-container mt-5">
...
if (typeof sectionLoader !== 'undefined' && sectionLoader.getCurrentSection && sectionLoader.getCurrentSection() === 'alerts') {
  setInterval(() => {
