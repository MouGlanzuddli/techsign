...
<nav class="sidebar">
    ...
    <h3>Reporting</h3>
    <ul>
        <li><a href="#" class="menu-link" data-file="statistics-reports.jsp" data-section="account-stats"><i class="fas fa-chart-bar"></i> Thống kê tài khoản</a></li>
    ...
    <h3>Other</h3>
    <ul>
        <li><a href="#" class="menu-link" data-file="settings.jsp" data-section="settings"><i class="fas fa-cog"></i> Cài đặt</a></li>
    </ul>
</nav> 