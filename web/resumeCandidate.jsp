                    ...
                    <div class="dashboard-nav">
                        ...
                        <div class="dashboard-inner">
                            ...
                            <ul data-submenu-title="Main Navigation">
                                ...
                                <li class="active"><a href="resumeCandidate.jsp"><i class="fa-solid fa-file-pdf me-2"></i>My Resumes</a></li>
                                            ...
                                            <div class="col-xl-4 col-lg-4 col-md-6">
                                                <div class="cd-resume-wraps position-relative">
                                                    <div class="cd-resume-cancel">
                                                        ...
                                                        <c:if test="${not empty param.uploadedCV}">
                                                            <a href="DownloadCVServlet?id=${param.uploadedCV}" class="btn btn-md btn-light-primary px-3">
