                    ...
                    <div class="dashboard-nav">
                        ...
                        <div class="dashboard-inner">
                            <ul data-submenu-title="Main Navigation">
                                ...
                                <li><a href="FavouriteCompanyServlet" method="doGet"><i class="fa-solid fa-user-clock me-2"></i>Favourite Companies</a></li>
                                                                ...
                                                                <div class="jbs-list-head-middle">
                                                                    <div class="elsocrio-jbs">
                                                                        <c:choose>
                                                                            ...
                                                                            <c:when test="${app.status == 'Not Approved'}">
                                                                                <span class="text-sm-muted text-light bg-success py-2 px-3 rounded">Not Approved</span>
                                                                            </c:when>
                                                                        </c:choose>
                                                                    </div>
                                                                </div>
                                    ...
                                    <ul class="pagination justify-content-center">
                                        <c:forEach begin="1" end="${totalPages}" var="i">
                                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                                <a class="page-link" href="AppliedJobsServlet?page=${i}">${i}</a>
                                            </li>
                                        </c:forEach>
                                    </ul>
                                </nav>
