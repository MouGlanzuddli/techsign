					...
					<div class="dashboard-nav">
						...
						<div class="dashboard-inner">
							<ul data-submenu-title="Main Navigation">
								<li><a href="CandidateDashboardServlet"><i class="fa-solid fa-gauge-high me-2"></i>User Dashboard</a></li>
								<li><a href="candidate-profiles.jsp"><i class="fa-regular fa-user me-2"></i>My Profile </a></li>
