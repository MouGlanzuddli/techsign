        ...
        <div id="main-wrapper">
			...
			<div class="dashboard-wrap bg-light">
					...
					<div class="dashboard-nav">
						...
						<div class="dashboard-inner">
							<ul data-submenu-title="Main Navigation">
								<li><a href="candidate-dashboard.jsp"><i class="fa-solid fa-gauge-high me-2"></i>User Dashboard</a></li>
								<li><a href="CandidateProfilesServlet"><i class="fa-regular fa-user me-2"></i>My Profile</a></li>
								<li><a href="candidate-resume.html"><i class="fa-solid fa-file-pdf me-2"></i>My Resume</a></li>
				...
				<div class="dashboard-content">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="py-3 text-center">ï¿½ 2015 - 2023 Job Stockï¿½ Themezhub.</div>
						</div>
					</div>
