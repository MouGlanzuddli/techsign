<%
    ...
    String[] industries = {"", "Information Technology", "Artificial Intelligence", "Software Engineering", "Data Analysis", "Information Security"};
    String industryName = (industryId != null && industryId > 0 && industryId <= 5) ? industries[industryId] : "";
					...
					<div class="dashboard-nav">
						...
						<div class="dashboard-inner">
							<ul data-submenu-title="Main Navigation">
								<li><a href="CompanyDashboardServlet"><i class="fa-solid fa-gauge-high me-2"></i>User Dashboard</a></li>
								<li class="active"><a href="UpdateCompanyProfileServlet"><i class="fa-regular fa-user me-2"></i>Company Profile </a></li>
					...
					<div class="dashboard-widg-bar d-block">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form action="UpdateCompanyProfileServlet" method="post" enctype="multipart/form-data" onsubmit="return validateProfileForm()">
										...
										<div class="col-xl-6 col-lg-6 col-md-12">
											<div class="form-group">
												...
												<select name="industryId" class="form-control" required>
													<option value="1" <%= (industryId != null && industryId == 1) ? "selected" : "" %>>Information Technology</option>
													<option value="2" <%= (industryId != null && industryId == 2) ? "selected" : "" %>>Artificial Intelligence</option>
													<option value="3" <%= (industryId != null && industryId == 3) ? "selected" : "" %>>Software Engineering</option>
													<option value="4" <%= (industryId != null && industryId == 4) ? "selected" : "" %>>Data Analysis</option>
                                                                                                        <option value="5" <%= (industryId != null && industryId == 5) ? "selected" : "" %>>Information Security</option>
												</select>
											</div>
										</div>
										<div class="col-xl-6 col-lg-6 col-md-12">
                    ...
                    input.addEventListener('change', function(event) {
                        ...
                        if (file && file.type.startsWith('image/')) {
                            ...
                            reader.onload = function(e) {
                                // T?m th? img g?n nh?t trong c?ng kh?i upload
