        ...
        <div class="dashboard-nav">
            ...
            <div class="dashboard-inner">
                <ul data-submenu-title="Main Navigation">
                    ...
                    <li><a href="ShortlistJobServlet"><i class="fa-solid fa-bookmark me-2"></i>List Saved Jobs</a></li>
                    <li class="active"><a href="FavouriteCompanyServlet"><i class="fa-solid fa-user-clock me-2"></i>Favourite Companies</a></li>
        ...
        <div class="dashboard-widg-bar d-block">
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <form method="get" action="FavouriteCompanyServlet">
                            <div class="card-header">
                                <div class="_mp-inner-content elior">
                                    <div class="_mp-inner-first">
                                        <div class="search-inline">
                                            <input type="text" id="keywordInput" name="search" class="form-control" placeholder="Company name..." value="${search}">
                    ...
                    <ul class="pagination justify-content-center">
                        <c:forEach begin="1" end="${totalPages}" var="i">
                            <li class="page-item ${i == currentPage ? 'active' : ''}">
                                <a class="page-link" href="FavouriteCompanyServlet?page=${i}&search=${search}">${i}</a>
                            </li>
                        </c:forEach>
                    </ul>
                </nav>
