...
<head>
    ...
    <title>${pageTitle != null ? pageTitle : 'Company Listings'} - TechSign</title>
    ...
    <style>
        ...
        * {
        ...
        .hero-search-content .row {
            align-items: end;
            gap: 65px; /* Increased spacing between fields for clearer separation */
            max-width: 1200px;
            margin: 0 auto;
        }
        ...
        .hero-search-content .form-group {
            margin-bottom: 0;
            width: 100%; /* Ensure each field takes full column width */
        }
        ...
        @media (max-width: 1200px) {
            ...
            .hero-search-content .col-xl-2 {
                flex: 0 0 100%;
                max-width: 100%;
                margin-bottom: 20px; /* Increased spacing when wrapping */
            }
            ...
            .hero-search-content .row {
                gap: 20px; /* Reduced gap on smaller screens to fit layout */
                flex-direction: column;
            }
        }
        ...
        @media (max-width: 768px) {
            ...
            .hero-search-content .row {
                gap: 15px; /* Further reduced gap on very small screens */
            }
        }
...
<body class="green-theme">
    ...
    <div id="main-wrapper">
                ...
                <nav id="navigation" class="navigation navigation-landscape">
                    ...
                    <div class="nav-menus-wrapper">
                        <ul class="nav-menu">
                            ...
                            <li class="active"><a href="CompanyListServlet">Company</a></li>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                                            <div class="d-flex align-items-center">
                                                <div class="company-logo-thumb me-2" style="width: 32px; height: 32px; font-size: 14px;">
                                                    <c:choose>
                                                        <c:when test="${not empty sessionScope.user.avatarUrl}">
                                                            <img src="${sessionScope.user.avatarUrl}" alt="User Avatar">
                                                        </c:when>
                                                        <c:otherwise>
        ...
        <!-- Enhanced Hero Section - Company Search Form -->
            ...
            <div class="container d-flex flex-column justify-content-center position-relative zindex-2 pt-5">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-9 col-md-10 text-center">
                        ...
                        <h1 class="mb-4 display-4 fw-bold">Learn About <span style="color: #17ac6a;">Recruiting Companies</span></h1>
                        <p class="fs-5 mb-4">Browse thousands of companies and career opportunities that match your skills.</p>
                        <div class="d-flex justify-content-center gap-3 mb-4">
                            <div class="text-center">
                                <h4 class="mb-0 text-white">${totalCompanies}+</h4>
                                <small class="text-light">Total Companies</small>
                            </div>
                            <div class="text-center">
                                <h4 class="mb-0 text-white">${companiesCount}+</h4>
                                <small class="text-light">Displayed Results</small>
                            </div>
                            <div class="text-center">
                                <h4 class="mb-0 text-white">50+</h4>
                                <small class="text-light">Featured Companies</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="hero-search-wrap mt-4">
                    <div class="hero-search-content">
                        <form action="CompanyListServlet" method="get">
                            <div class="row g-4 align-items-end">
                                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label class="form-label">Company Keyword</label>
                                        <div class="input-with-icon">
                                            <input type="text" class="form-control" name="search" placeholder="e.g. FPT, Viettel, Techcombank..." value="${searchKeyword}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="industry">
                                            ...
                                            <c:forEach var="ind" items="${industries}">
                                                <option value="${ind}" ${industryFilter == ind ? 'selected' : ''}>${ind}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="stats-section">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div>
                            <h5 class="mb-1">
                                <strong>${companiesCount}</strong> Companies Found
                            </h5>
                            <p class="text-muted mb-0">Displaying top companies for you</p>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="filter-content">
                            <h4>Filter Search</h4>
                            <form action="CompanyListServlet" method="get" id="filterForm">
                                ...
                                <div class="single-tabs-group">
                                    ...
                                    <div class="single-tabs-group-content">
                                        <select class="form-control" name="industry" onchange="this.form.submit()">
                                            <option value="">All Industries</option>
                                            <c:forEach var="ind" items="${industries}">
                                                <option value="${ind}" ${industryFilter == ind ? 'selected' : ''}>${ind}</option>
                                            </c:forEach>
                                ...
                                <%-- Add more filters here if needed, e.g., Company Size, Company Type --%>
                                <%--
                                <div class="single-tabs-group">
                                    <div class="single-tabs-group-header">
                                        <h5>Company Size</h5>
                                    ...
                                    <div class="single-tabs-group-content">
                                        <select class="form-control" name="companySize" onchange="this.form.submit()">
                                            <option value="">All</option>
                                            <option value="1-10" ${companySizeFilter == '1-10' ? 'selected' : ''}>1-10 Employees</option>
                                            <option value="11-50" ${companySizeFilter == '11-50' ? 'selected' : ''}>11-50 Employees</option>
                                            <option value="51-200" ${companySizeFilter == '51-200' ? 'selected' : ''}>51-200 Employees</option>
                                            <option value="201-500" ${companySizeFilter == '201-500' ? 'selected' : ''}>201-500 Employees</option>
                                            <option value="500+" ${companySizeFilter == '500+' ? 'selected' : ''}>500+ Employees</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="single-tabs-group">
                                    ...
                                    <div class="single-tabs-group-content">
                                        <select class="form-control" name="companyType" onchange="this.form.submit()">
                                            <option value="">All</option>
                                            <option value="Product" ${companyTypeFilter == 'Product' ? 'selected' : ''}>Product Company</option>
                                            <option value="Service" ${companyTypeFilter == 'Service' ? 'selected' : ''}>Service Company</option>
                                            <option value="Startup" ${companyTypeFilter == 'Startup' ? 'selected' : ''}>Startup</option>
                                            <option value="Enterprise" ${companyTypeFilter == 'Enterprise' ? 'selected' : ''}>Enterprise</option>
                                        </select>
                                    </div>
                                </div>
                                --%>
                                ...
                                <div class="single-tabs-group">
                                    ...
                                    <div class="single-tabs-group-content">
                                        <select class="form-control" name="sortBy" onchange="this.form.submit()">
                                            ...
                                            <option value="name" ${sortBy == 'name' ? 'selected' : ''}>Company Name (A-Z)</option>
                                ...
                                <div class="filt-buttons-updates">
                                    <a href="CompanyListServlet" class="btn btn-outline-secondary full-width mb-2">
                                        Clear Filters
                                    </a>
                                </div>
                            </form>
                    ...
                    <div class="col-lg-9">
                        ...
                        <c:if test="${not empty error}">
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <i class="fas fa-exclamation-circle me-2"></i>Database Error: ${error}
                                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                            </div>
                        </c:if>
                        ...
                        <c:choose>
                            <c:when test="${empty companies}">
                                <div class="no-results">
                                    ...
                                    <p class="text-muted mb-4">We couldn't find any companies matching your criteria. Try adjusting your search keywords or filters.</p>
                                    <div class="d-flex gap-3 justify-content-center">
                                        <a href="CompanyListServlet" class="btn btn-dark">View All Companies</a>
                                        <%-- <a href="#" class="btn btn-outline-primary">Register Company</a> --%>
                                    </div>
                                </div>
                            </c:when>
                            <c:otherwise>
                                            ...
                                            <div class="company-card">
                                                <div class="company-card-header">
                                                    <div class="d-flex justify-content-between align-items-start">
                                                        <div class="left-tags-capt">
                                                            <c:if test="${company.featured}">
                                                                <span class="featured-text">Featured</span>
                                                            </c:if>
                                                        </div>
                                                        <span class="badge bg-light text-dark">
                                                            <i class="fas fa-briefcase me-1"></i> ${company.openJobs} Jobs
                                                        </span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="company-card-body">
                                                    <div class="d-flex align-items-start mb-3">
                                                        <div class="company-logo-thumb me-3">
                                                            <c:choose>
                                                        ...
                                                        <div class="flex-grow-1">
                                                            <h4 class="company-title mb-1">
                                                                <a href="CompanyDetailServlet?id=${company.id}" class="text-decoration-none">
                                                                    ${company.companyName}
                                                                </a>
                                                            </h4>
                                                            <p class="text-muted mb-0">
                                                                ...
                                                                <c:if test="${empty company.industry}">
                                                                    Undefined Industry
                                                                </c:if>
                                                            </p>
                                                        </div>
                                                    ...
                                                    <div class="company-details text-muted small mb-3">
                                                        ...
                                                        <c:if test="${not empty company.website}">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <a href="${company.website}" target="_blank" class="text-decoration-none text-muted">
                                                                    ${company.website}
                                                                </a>
                                                            </div>
                                                        </c:if>
                                                ...
                                                <div class="company-card-footer">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="text-muted small">
                                                            <i class="fas fa-calendar me-1"></i> Joined: <fmt:formatDate value="${company.createdAt}" pattern="MMM dd, yyyy"/>
                                                        </div>
                                                        <div>
                                                            <a href="CompanyDetailServlet?id=${company.id}" class="btn btn-primary btn-sm">
                    ...
                    <div class="modal-body">
                        <% if (request.getAttribute("error") != null) { %>
                            <div class="alert alert-danger d-flex align-items-center">
                                ...
                                Database Error: <%= request.getAttribute("error") %>
                            </div>
                        <% } %>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Add loading animation to company cards
