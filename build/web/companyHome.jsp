        ...
        <nav id="navigation" class="navigation navigation-landscape">
            ...
            <div class="nav-menus-wrapper">
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                     ...
                     <li>
                        <a href="postJob.jsp" class="post-job-btn">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="PostJobServlet" method="POST" id="postJobForm" class="needs-validation" novalidate>
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="salary" class="form-label required-field">Salary Range</label>
                            <input type="text" class="form-control" id="salary" name="salary" placeholder="e.g., $50k-$70k" required>
                            <div class="invalid-feedback">Please enter salary information.</div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="expiryDate" class="form-label required-field">Application Deadline</label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="postJobForm" class="btn btn-primary">Post Job</button>
            </div>
        </div>
    </div>
</div>
				...
				<div class="container d-flex flex-column justify-content-center position-relative zindex-2 pt-sm-3 pt-md-4 pt-xl-5">
					...
					<div class="row justify-content-between align-items-center">
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							...
							<h1 class="mb-4">Find & Hire<br><span>Top Experts on Tech Sign </span></h1>
							<p class="fs-5">Getting a new job is never easy. Check what new jobs we have in store for you on Tech Sign.</p>
							<div class="lios-vrst">
								<ul>
									<li>
						...
						<div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
							<div class="hero-search-wrap">
								<div class="hero-search">
									<h1>Grow Your Career with <span class="text-primary">Tech Sign</span></h1>
								</div>
										...
										<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
											<div class="form-group">
												...
												<select class="form-control">
													...
													<option value="2">$200 - $5000 </option>
													<option value="3">$5000 - $10000 </option>
													<option value="4">$10000 - $20000 </option>
													<option value="5">$20000 - $40000 </option>
													<option value="6">$40000 - $50000 </option>
													<option value="7">$50000 - $100000 </option>
												</select>
											</div>
										</div>
					...
					<div class="row justify-content-center gx-xl-3 gx-3 gy-4">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-1.png" class="img-fluid" alt=""></a>
								</div>
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-2.png" class="img-fluid" alt=""></a>
								</div>
								<div class="job-instructor-content">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-3.png" class="img-fluid" alt=""></a>
								</div>
								<div class="job-instructor-content">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-4.png" class="img-fluid" alt=""></a>
								</div>
								<div class="job-instructor-content">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="brows-job-type"><span class="freelanc">Freelancer</span></div>
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-5.png" class="img-fluid" alt=""></a>
								</div>
								<div class="job-instructor-content">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="brows-job-type"><span class="part-time">Part Time</span></div>
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-6.png" class="img-fluid" alt=""></a>
								</div>
								<div class="job-instructor-content">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-7.png" class="img-fluid" alt=""></a>
								</div>
								<div class="job-instructor-content">
						...
						<div class="col-xl-3 col-lg-4 col-md-6 col-sm-12">
							<div class="job-instructor-layout border">
								...
								<div class="brows-job-type"><span class="enternship">Enternship</span></div>
								<div class="job-instructor-thumb">
									<a href="job-detail.html"><img src="${pageContext.request.contextPath}/assets/img/l-8.png" class="img-fluid" alt=""></a>
								</div>
								<div class="job-instructor-content">
					...
					<div class="row justify-content-center gx-xl-4 gx-lg-4">
						...
						<div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 order-xl-2 order-lg-3 order-md-3">
							<div class="eslio-pincc m-auto">
								<img src="${pageContext.request.contextPath}/assets/img/wp-iphone.png" class="img-fluid" alt="">
							</div>
						</div>
					...
					<div class="row justify-content-center gx-4 gy-4">
							...
							<div class="jobstock-reviews-box">
								...
								<div class="jobstock-reviews-flex">
									<div class="jobstock-reviews-thumb">
										<div class="jobstock-reviews-figure"><img src="${pageContext.request.contextPath}/assets/img/team-1.jpg" class="img-fluid circle" alt=""></div>
									</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="jobstock-reviews-box">
								...
								<div class="jobstock-reviews-flex">
									<div class="jobstock-reviews-thumb">
										<div class="jobstock-reviews-figure"><img src="${pageContext.request.contextPath}/assets/img/team-2.jpg" class="img-fluid circle" alt=""></div>
									</div>
									<div class="jobstock-reviews-caption">
						...
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="jobstock-reviews-box">
								...
								<div class="jobstock-reviews-flex">
									<div class="jobstock-reviews-thumb">
										<div class="jobstock-reviews-figure"><img src="${pageContext.request.contextPath}/assets/img/team-3.jpg" class="img-fluid circle" alt=""></div>
									</div>
									<div class="jobstock-reviews-caption">
						...
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="jobstock-reviews-box">
								...
								<div class="jobstock-reviews-flex">
									<div class="jobstock-reviews-thumb">
										<div class="jobstock-reviews-figure"><img src="${pageContext.request.contextPath}/assets/img/team-4.jpg" class="img-fluid circle" alt=""></div>
									</div>
									<div class="jobstock-reviews-caption">
						...
						<div class="col-xl-4 col-lg-4 col-md-6">
							<div class="jobstock-reviews-box">
								...
								<div class="jobstock-reviews-flex">
									<div class="jobstock-reviews-thumb">
										<div class="jobstock-reviews-figure"><img src="${pageContext.request.contextPath}/assets/img/team-5.jpg" class="img-fluid circle" alt=""></div>
									</div>
									<div class="jobstock-reviews-caption">
        ...
        <div class="modal-flex-item mb-3">
            ...
            <div class="modal-footer">
                <p>Don't have an account yet?
                    <a href="${pageContext.request.contextPath}/signup.jsp" class="text-primary font--bold ms-1">Sign Up</a>
                </p>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
		...
		<!-- Job Posting Scripts -->
		<script>
			// Show modal when clicking Post Job button
			...
			function updatePreview() {
				...
				document.getElementById('previewType').textContent = document.getElementById('jobType').value;
				document.getElementById('previewLocation').textContent = document.getElementById('jobLocation').value || 'Location';
				document.getElementById('previewSalary').textContent = document.getElementById('salaryRange').value || 'Salary Range';
				document.getElementById('previewWorkingDays').textContent = document.getElementById('workingDays').value;
				
				// Format time for preview
				const startTime = document.getElementById('startTime').value;
				const endTime = document.getElementById('endTime').value;
				const formattedStartTime = startTime ? new Date(`2000-01-01T${startTime}`).toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true }) : '';
				const formattedEndTime = endTime ? new Date(`2000-01-01T${endTime}`).toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true }) : '';
				document.getElementById('previewWorkingHours').textContent = startTime && endTime ? `${formattedStartTime} - ${formattedEndTime}` : 'Working hours will appear here...';
				
				document.getElementById('previewOvertime').textContent = document.getElementById('overtimePolicy').value;
				document.getElementById('previewDescription').textContent = document.getElementById('jobDescription').value || 'Job description will appear here...';
				document.getElementById('previewRequirements').textContent = document.getElementById('jobRequirements').value || 'Job requirements will appear here...';
			}

			// Function to show preview tab
			function showPreview() {
				updatePreview();
				document.getElementById('preview-tab').click();
			}

			// Function to submit job post
			function submitJobPost() {
				const form = document.getElementById('postJobForm');
				const formData = new FormData(form);
				const jobData = Object.fromEntries(formData.entries());
				
				// Add company_id (you should get this from the session)
				jobData.company_id = 1; // Replace with actual company ID from session
				...
				.then(data => {
					if (data.message === 'Job posted successfully') {
						...
						// Close the modal
						var postJobModal = bootstrap.Modal.getInstance(document.getElementById('postJobModal'));
						postJobModal.hide();
						// Reset the form
						form.reset();
						// Optionally refresh the page or update the job list
						location.reload();
					} else {
			...
			document.getElementById('postJobModal').addEventListener('shown.bs.modal', function () {
				updatePreview();
			});
		...
		<script>
			...
			// Set maximum date for expiry date to 1 year from now
			const maxDate = new Date();
			maxDate.setFullYear(maxDate.getFullYear() + 1);
			document.getElementById('expiryDate').max = maxDate.toISOString().split('T')[0];
		</script>
