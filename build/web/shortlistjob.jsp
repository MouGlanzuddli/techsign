                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-with-icon">
                                                            <select name="location" class="form-control">
                                                                ...
                                                                <option value="Ho Chi Minh City" ${param.location == 'Ho Chi Minh City' ? 'selected' : ''}>TP.HCM</option>
                                                                <option value="Da Nang" ${param.location == 'Da Nang' ? 'selected' : ''}>Đà Nẵng</option>
                                                            </select>
                                        ...
                                        <div class="row justify-content-start gx-3 gy-4">
                                            ...
                                            <c:if test="${totalJobs > 0}">
                                                <div class="pagination">
                                                    <c:forEach begin="1" end="${(totalJobs + pageSize - 1) div pageSize}" var="i">
                                                        <a href="ShortlistJobServlet?page=${i}&keyword=${param.keyword}&city=${param.city}&description=${param.description}"
