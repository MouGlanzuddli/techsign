...
public class JobPostingDAO {
    ...
    public boolean deleteJobPosting(int id) {
        ...
        try {
            ...
            try (PreparedStatement stmt1 = connection.prepareStatement(deleteCategoriesSql)) {
                stmt1.setInt(1, id);
                stmt1.executeUpdate();

                try (PreparedStatement stmt2 = connection.prepareStatement(deleteJobSql)) {
                    stmt2.setInt(1, id);
    ...
    private JobPosting mapResultSetToJobPosting(ResultSet rs) throws SQLException {
        ...
        // Removed: jobPosting.setCategoryNames(rs.getString("category_names"));
