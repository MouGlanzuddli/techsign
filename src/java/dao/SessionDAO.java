...
public class SessionDAO {
    public List<Session> getSessionsByUser(int userId) throws SQLException, ClassNotFoundException {
    ...
    public boolean forceLogout(int sessionId) throws SQLException, ClassNotFoundException {
    ...
    public boolean updateLastActive(int sessionId) throws SQLException, ClassNotFoundException {
