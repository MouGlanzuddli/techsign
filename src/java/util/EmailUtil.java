...
public class EmailUtil {
    ...
    public static void sendPostApprovalEmail(String toEmail, String postTitle, String viewUrl) throws MessagingException {
        String subject = "Your Job Post Has Been Approved: " + postTitle;
        String body = String.format(
            "<html><body>" +
            "<h2>Job Post Approved</h2>" +
            "<p>Your job posting <strong>%s</strong> has been approved.</p>" +
            "<p><a href=\"%s\">View your posting</a></p>" +
    ...
    public static void sendPostRejectionEmail(String toEmail, String postTitle, String reason, String editUrl) throws MessagingException {
        String subject = "Your Job Post Requires Modifications: " + postTitle;
        String body = String.format(
            "<html><body>" +
            "<h2>Job Post Requires Changes</h2>" +
            "<p>Your job posting <strong>%s</strong> needs modifications before approval.</p>" +
            "<p><strong>Reason:</strong> %s</p>" +
            "<p><a href=\"%s\">Edit your posting</a></p>" +
            "</body></html>",
            postTitle, reason, editUrl
        );
