...
import model.Skill;
@WebServlet(name = "SearchandView", urlPatterns = {"/SearchandView"})
public class SearchandView extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] jobtype = request.getParameterValues("categories");
        String keyword = request.getParameter("keyword");
        String sortBy = request.getParameter("sortBy");
        ...
        try (Connection conn = new DBContext().getConnection()) {
            ...
            List<JobPosting> allJobs = dao.filterJobs(
                    placeOfWork, contractTypes, employmentTypes, salaryRange, jobtype, keyword
            );
