...
public class JobDetailServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Lấy thông tin company - sửa lỗi getEmployerId() thành getCompanyId()
            User company = null;
            try {
            ...
            if (currentUser != null && currentUser.getRoleId() == 2) { // role_id = 2 là candidate
                ...
                hasApplied = applicationDao.hasApplied(currentUser.getId(), jobId);
            ...
            List<Job> relatedJobs = jobDao.getRelatedJobs(jobId, job.getCategory(), job.getCompanyId(), 5);
