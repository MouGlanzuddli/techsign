...
@WebServlet(name = "ToggleCandidateProfileVisibility", urlPatterns = {"/ToggleCandidateProfileVisibility"})
public class ToggleCandidateProfileVisibilityServlet extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("UpdateCandidateProfile");
    }
} 